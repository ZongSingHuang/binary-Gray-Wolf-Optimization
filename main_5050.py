...
for i in range(times):
    ...
    optimizer = bGWO(fit_func=loss10, 
    ...
    optimizer = bGWO(fit_func=loss11, 
    ...
    optimizer = bGWO(fit_func=loss12, 
    ...
    optimizer = bGWO(fit_func=loss13, 
    ...
    optimizer = bGWO(fit_func=loss14, 
    ...
    optimizer = bGWO(fit_func=loss15, 
    ...
    optimizer = bGWO(fit_func=loss16, 
    ...
    optimizer = bGWO(fit_func=loss17, 
    ...
    optimizer = bGWO(fit_func=loss18, 
